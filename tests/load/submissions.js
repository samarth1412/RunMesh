...
export default function () {
  const response = http.post(`${api}/v1/workflows/${workflow}/runs`, JSON.stringify({ input: { value: Math.random() } }), { headers: { 'Content-Type': 'application/json', 'Idempotency-Key': randomUUID() } });
